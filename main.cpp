...
public:
    ...
    bool word_recognized(std::string word="only_for_testing") {
...
//        size_t fake_initial = add_state();
//        int initial_cnt = 0; TODO
        for (auto& state : states) {
...
//                if (state.is_initial) {
//                    ++initial_cnt;
//                } else if (state.is_initial && initial_cnt >= 2) {
//                    states[to->second].is_initial = true;
//                }
